...
Route::get('/admin', 'HomeController@index')->name('home');  //bisogna andare nella HomeController@index per modificare la route aggiungendo la cartella admin  //modificare la home in RouteServiceProvider.php
